...
class OverlayCanvas(QWidget):
    ...
    def paintEvent(self, event) -> None:  # noqa: N802
        ...
        mapping_rect = self._map_image_to_overlay(*self._image_size)
        ...
        for idx, region in enumerate(self._regions):
            ...
            rect = self._map_region_rect(region, mapping_rect, *self._image_size)
    ...
    def _map_image_to_overlay(self, image_w: int, image_h: int) -> QRect:
    ...
    def _map_region_rect(self, region: Region, mapping_rect: QRect, image_w: int, image_h: int) -> QRect:
