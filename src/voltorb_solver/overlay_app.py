...
# Shared defaults for event textboxes (game_clear / play_level / game_failed).
# All three share the same on-screen region, match threshold, and board-relative geometry.
_TEXTBOX_EVENT_REGION = (0.07, 0.9, 0.2, 0.935)
_TEXTBOX_EVENT_MATCH_THRESHOLD = 0.90
_TEXTBOX_EVENT_BOARD_X = 0.014
_TEXTBOX_EVENT_BOARD_Y = 0.8
_TEXTBOX_EVENT_BOARD_W = 0.386
_TEXTBOX_EVENT_BOARD_H = 0.13

_TEXTBOX_GAME_CLEAR_REGION = _TEXTBOX_EVENT_REGION
_TEXTBOX_GAME_CLEAR_TEMPLATE_PATH = Path("assets/templates/textbox_game_clear.png")
_TEXTBOX_GAME_CLEAR_MATCH_THRESHOLD = _TEXTBOX_EVENT_MATCH_THRESHOLD
_TEXTBOX_GAME_CLEAR_BOARD_X = _TEXTBOX_EVENT_BOARD_X
_TEXTBOX_GAME_CLEAR_BOARD_Y = _TEXTBOX_EVENT_BOARD_Y
_TEXTBOX_GAME_CLEAR_BOARD_W = _TEXTBOX_EVENT_BOARD_W
_TEXTBOX_GAME_CLEAR_BOARD_H = _TEXTBOX_EVENT_BOARD_H

_TEXTBOX_PLAY_LEVEL_REGION = _TEXTBOX_EVENT_REGION
_TEXTBOX_PLAY_LEVEL_TEMPLATE_PATH = Path("assets/templates/textbox_play_level.png")
_TEXTBOX_PLAY_LEVEL_MATCH_THRESHOLD = _TEXTBOX_EVENT_MATCH_THRESHOLD
_TEXTBOX_PLAY_LEVEL_BOARD_X = _TEXTBOX_EVENT_BOARD_X
_TEXTBOX_PLAY_LEVEL_BOARD_Y = _TEXTBOX_EVENT_BOARD_Y
_TEXTBOX_PLAY_LEVEL_BOARD_W = _TEXTBOX_EVENT_BOARD_W
_TEXTBOX_PLAY_LEVEL_BOARD_H = _TEXTBOX_EVENT_BOARD_H

_TEXTBOX_GAME_FAILED_REGION = _TEXTBOX_EVENT_REGION
_TEXTBOX_GAME_FAILED_TEMPLATE_PATH = Path("assets/templates/textbox_game_failed.png")
_TEXTBOX_GAME_FAILED_MATCH_THRESHOLD = _TEXTBOX_EVENT_MATCH_THRESHOLD
_TEXTBOX_GAME_FAILED_BOARD_X = _TEXTBOX_EVENT_BOARD_X
_TEXTBOX_GAME_FAILED_BOARD_Y = _TEXTBOX_EVENT_BOARD_Y
_TEXTBOX_GAME_FAILED_BOARD_W = _TEXTBOX_EVENT_BOARD_W
_TEXTBOX_GAME_FAILED_BOARD_H = _TEXTBOX_EVENT_BOARD_H
...
class OverlayControlWindow(QMainWindow):
    ...
    def __init__(self) -> None:
        ...
        self.prob_overlay_btn.setFocusPolicy(Qt.FocusPolicy.NoFocus)
        ...
        runtime_btn_row.addWidget(self.prob_overlay_btn)
        runtime_btn_row.addSpacing(12)
